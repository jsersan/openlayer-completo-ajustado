...
exports.estadisticas = exports.familiasProfesionales = exports.filtrarCiclos = exports.ciclos = void 0;
exports.ciclos = [
...
exports.filtrarCiclos = {
    porGrado: function (grado) {
        return exports.ciclos.filter(function (ciclo) { return ciclo.grado === grado; });
    },
    porFamilia: function (familia) {
        return exports.ciclos.filter(function (ciclo) { return ciclo.familia === familia; });
    },
    porModalidad: function (modalidad) {
        return exports.ciclos.filter(function (ciclo) { return ciclo.modalidad === modalidad; });
    },
    porTurno: function (turno) {
        return exports.ciclos.filter(function (ciclo) { return ciclo.turno === turno; });
    },
    porIdioma: function (idioma) {
        return exports.ciclos.filter(function (ciclo) { return ciclo.idiomas.includes(idioma); });
    },
    porCentro: function (codigoCentro) {
        return exports.ciclos.filter(function (ciclo) { return ciclo.centros.includes(codigoCentro); });
    },
    disponiblesEnIngles: function () {
        return exports.ciclos.filter(function (ciclo) { return ciclo.idiomas.includes('EN'); });
    },
    modalidadDual: function () {
        return exports.ciclos.filter(function (ciclo) { return ciclo.modalidad === 'Dual'; });
    },
    aDistancia: function () {
        return exports.ciclos.filter(function (ciclo) { return ciclo.modalidad === 'Distancia'; });
    },
    buscarPorTexto: function (texto) {
        return exports.ciclos.filter(function (ciclo) {
            return ciclo.nom.toLowerCase().includes(texto.toLowerCase()) ||
...
exports.familiasProfesionales = __spreadArray([], new Set(exports.ciclos.map(function (c) { return c.familia; })), true).sort();
// Estadísticas de la oferta formativa
exports.estadisticas = {
    totalCiclos: exports.ciclos.length,
    porGrado: {
        basico: exports.ciclos.filter(function (c) { return c.grado === 'Básico'; }).length,
        medio: exports.ciclos.filter(function (c) { return c.grado === 'Medio'; }).length,
        superior: exports.ciclos.filter(function (c) { return c.grado === 'Superior'; }).length
    },
    porModalidad: {
        presencial: exports.ciclos.filter(function (c) { return c.modalidad === 'Presencial'; }).length,
        dual: exports.ciclos.filter(function (c) { return c.modalidad === 'Dual'; }).length,
        distancia: exports.ciclos.filter(function (c) { return c.modalidad === 'Distancia'; }).length
    },
    totalFamilias: exports.familiasProfesionales.length,
    ciclosEnIngles: exports.ciclos.filter(function (c) { return c.idiomas.includes('EN'); }).length
};
exports["default"] = exports.ciclos;
